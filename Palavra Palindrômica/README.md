Algoritmo que resolve se uma cadeia de caracteres é um palíndromo. Foi utilizado o conceito de pilha e as operações que caracterizam um tipo abstrato de dado (TAD) pilha.
